...
export const OnePlusKopiMenu: Beverage[] = [
  { id: 101, category: Category.HotTraditionalCoffee, name: "Kopi O (Hot)", price: 1.1 },
  { id: 102, category: Category.IcedTraditionalCoffee, name: "Kopi O (Iced)", price: 1.4 },
  { id: 103, category: Category.HotTraditionalCoffee, name: "Teh O (Hot)", price: 1.1 },
  { id: 104, category: Category.IcedTraditionalCoffee, name: "Teh O (Iced)", price: 1.4 },
  { id: 105, category: Category.HotTraditionalCoffee, name: "Kopi (Hot)", price: 1.2 },
  { id: 106, category: Category.IcedTraditionalCoffee, name: "Kopi (Iced)", price: 1.7 },
  { id: 107, category: Category.HotTraditionalCoffee, name: "Teh (Hot)", price: 1.2 },
  { id: 108, category: Category.IcedTraditionalCoffee, name: "Teh (Iced)", price: 1.7 },
  { id: 109, category: Category.HotTraditionalCoffee, name: "Kopi C (Hot)", price: 1.4 },
  { id: 110, category: Category.IcedTraditionalCoffee, name: "Kopi C (Iced)", price: 1.9 },
  { id: 111, category: Category.HotTraditionalCoffee, name: "Teh C (Hot)", price: 1.4 },
  { id: 112, category: Category.IcedTraditionalCoffee, name: "Teh C (Iced)", price: 1.9 },
  { id: 113, category: Category.HotTraditionalCoffee, name: "HK Yuan Yang (Hot)", price: 1.7 },
  { id: 114, category: Category.IcedTraditionalCoffee, name: "HK Yuan Yang (Iced)", price: 2.2 },
  { id: 115, category: Category.HotTraditionalCoffee, name: "Milo (Hot)", price: 1.4 },
  { id: 116, category: Category.IcedTraditionalCoffee, name: "Milo (Iced)", price: 1.9 },
  { id: 117, category: Category.HotTraditionalCoffee, name: "Milo C (Hot)", price: 1.5 },
  { id: 118, category: Category.IcedTraditionalCoffee, name: "Milo C (Iced)", price: 2.0 },
  { id: 119, category: Category.HotTraditionalCoffee, name: "Lemon Tea (Hot)", price: 1.4 },
  { id: 120, category: Category.IcedTraditionalCoffee, name: "Lemon Tea (Iced)", price: 1.7 },
  ...
  { id: 125, category: Category.IcedTraditionalCoffee, name: "Milo Dino (Iced)", price: 3.0 },
  { id: 126, category: Category.IcedTraditionalCoffee, name: "Milo-Coffee Dino (Iced)", price: 3.0 },
